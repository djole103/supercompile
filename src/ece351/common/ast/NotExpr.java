...
// TODO: 19 lines snipped
    	if(localexpr.equivalent(ConstantExpr.TrueExpr))return ConstantExpr.FalseExpr;
    	if(localexpr.equivalent(ConstantExpr.FalseExpr))return ConstantExpr.TrueExpr;
    	if(NotExpr.class.isInstance(localexpr)) return ((NotExpr)localexpr).expr;
